...
=======
      user_id: { type: Sequelize.INTEGER, references: { model: "usuario", key: "id" }, onDelete: "CASCADE", allowNull: true},
      artist_id: { type: Sequelize.INTEGER, references: { model: "artist", key: "id" }, onDelete: "CASCADE", allowNull: true},
>>>>>>> 1e62340 (Cambios para cambio de rama)
    ...
    await queryInterface.createTable("song_like", {
      user_id: { type: Sequelize.INTEGER, references: { model: "usuario", key: "id" }, onDelete: "CASCADE", primaryKey: true },
      song_id: { type: Sequelize.INTEGER, references: { model: "song", key: "id" }, onDelete: "CASCADE", primaryKey: true }
    });
    ...
    await queryInterface.createTable("friendship", {
      user1_id: { type: Sequelize.INTEGER, references: { model: "usuario", key: "id" }, onDelete: "CASCADE", primaryKey: true },
      user2_id: { type: Sequelize.INTEGER, references: { model: "usuario", key: "id" }, onDelete: "CASCADE", primaryKey: true },
