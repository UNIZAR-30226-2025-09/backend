...
export async function up(queryInterface, Sequelize) {
  return queryInterface.bulkInsert('song_playlist', [
    ...
    { song_id: 5, playlist_id: 5, date: new Date("2024-07-02") },
      ...
      //Los 200 España
    { song_id: 1, playlist_id: 6, date: new Date("2025-03-23") },
    { song_id: 2, playlist_id: 6, date: new Date("2025-03-23") },
    { song_id: 3, playlist_id: 6, date: new Date("2025-03-23") },
    { song_id: 5, playlist_id: 6, date: new Date("2025-03-23") },
    { song_id: 6, playlist_id: 6, date: new Date("2025-03-23") },
    { song_id: 7, playlist_id: 6, date: new Date("2025-03-23") },
    { song_id: 8, playlist_id: 6, date: new Date("2025-03-23") },
    { song_id: 9, playlist_id: 6, date: new Date("2025-03-23") },
    { song_id: 10, playlist_id: 6, date: new Date("2025-03-23") },
    { song_id: 11, playlist_id: 6, date: new Date("2025-03-23") },
    { song_id: 12, playlist_id: 6, date: new Date("2025-03-23") },
    { song_id: 13, playlist_id: 6, date: new Date("2025-03-23") },
    { song_id: 14, playlist_id: 6, date: new Date("2025-03-23") },
    { song_id: 15, playlist_id: 6, date: new Date("2025-03-23") },
    { song_id: 16, playlist_id: 6, date: new Date("2025-03-23") },
