...
import { registerUser, loginUser, logoutUser, getUserProfile, updateUserProfile, updatePremiumStatus, checkEmailExistence, getUserById, updateUser, updateUserFavoriteStyleInProfile, getRecommendedPlaylistsForUser, forgotPassword, resetPassword, sendContactMessage, useDailySkip} from "#src/controllers/user_controller";
 ...
 *     description: Envía un mensaje de contacto al administrador del sistema
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *                 message:
 *                   type: string
 *                   example: "¡Gracias por contactarnos! Tu mensaje ha sido enviado correctamente."
 *       400:
 ...
 *                 error:
 *                   type: string
 *                   example: "Error al procesar el mensaje de contacto"
 */
